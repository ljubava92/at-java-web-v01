...
public class RegistrationPage {
    SelenideElement
            ...
            buttonReturnFlightListPage = $x("//button[contains(.,'Вернуться к найденным рейсам')]"),
            fio = $("#passengerName"),
    ...
    @Step("Вернуться к найденным рейсам после успешной регистрации")
    public void setButtonReturnFlightListPage() {
        buttonReturnFlightListPage.click();
    }
}